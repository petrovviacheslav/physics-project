...
import {DrawElectromagnetic} from "./DrawElectromagnetic";
import {useDispatch} from "react-redux";
import {clearCanvas} from "../../util/addsToScene";

const ManipulationElectromagneticForm = ({scene, camera, renderer}) => {
    ...
    const [tension, setTension] = useState({tension_x: 1, tension_y: 0, tension_z: 1});
    ...
    const updateCanvas = (e) => {
        ...
        DrawElectromagnetic(particles, induction, tension, 0.1, addConstructions, scene, camera, renderer, dispatch);
    };
            ...
            <form onSubmit={(e) => e.preventDefault()}>
                ...
                <table className="vector-table">
                    ...
                    <tr>
                        ...
                        <th className="first-cell">По X (*1e-2)</th>
                        <th className="first-cell">По Y (*1e-2)</th>
                        <th className="first-cell">По Z (*1e-2)</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                ...
                <table className="vector-table">
                    ...
                    <tr>
                        <th className="first-cell">Координата</th>
                        <th className="first-cell">По X (*1)</th>
                        <th className="first-cell">По Y (*1)</th>
                        <th className="first-cell">По Z (*1)</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
...
export default ManipulationElectromagneticForm;
